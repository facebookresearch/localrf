...
def parse_args():
	...
	parser.add_argument("--run_colmap", default=False, action="store_true", help="run colmap first on the image folder")
	...
	parser.add_argument("--colmap_db", default="data/sequenced/train_small/Caterpillar/colmap_ngp.db", help="colmap database filename")
	...
	parser.add_argument("--images", default="data/sequenced/train_small/Caterpillar/images", help="input path to the images")
	...
	parser.add_argument("--out", default="data/sequenced/train_small/Caterpillar/transforms.json", help="output path")
...
def run_colmap(args):
	...
	do_system(f"colmap feature_extractor --database_path {db} --image_path {images}")

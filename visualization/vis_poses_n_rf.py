...
layout = go.Layout(
    ...
    updatemenus=[{
        ...
        'type': 'buttons'}],
    scene={
        'xaxis': {'range': [-20, 20], 'rangemode': 'tozero', 'tickmode': "linear", 'tick0': -2, 'dtick': 1},
        'yaxis': {'range': [-20, 20], 'rangemode': 'tozero', 'tickmode': "linear", 'tick0': -2, 'dtick': 1},
        'zaxis': {'range': [-20, 20], 'rangemode': 'tozero', 'tickmode': "linear", 'tick0': -2, 'dtick': 1},
        # 'xaxis': {},
        # 'yaxis': {},
        # 'zaxis': {},
        'aspectratio': {
...
for c in range(0, num_frames, int(20)):
    # if c == 20:
    #     color = "red"
    # elif c == 540:
    #     color = "cyan"
